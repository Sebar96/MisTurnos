...
const I18n = {
    ...
    translations: {
        es: {
            ...
            'steps.s1.desc': 'Nombre, obra social, alergias, medicación — todo en un lugar solo.',
            ...
            'features.f1.desc': 'Historial completo: datos, alergias, medicación, observaciones.',
            ...
            'features.f4.title': 'Modo oscuro',
            'features.f4.desc': 'Trabajá de noche sin quemarte los ojos.',
        ...
        en: {
            ...
            'steps.s1.desc': 'Name, insurance, allergies, medication — all in one place.',
            ...
            'features.f1.desc': 'Complete history: data, allergies, medication, notes.',
            ...
            'features.f4.title': 'Dark mode',
            'features.f4.desc': 'Work at night without straining your eyes.',
